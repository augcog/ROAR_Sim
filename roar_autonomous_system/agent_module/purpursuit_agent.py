...
from roar_autonomous_system.control_module.pure_pursuit_control import PurePursuitController
...
class PurePursuitAgent(Agent):
    def __init__(self, vehicle: Vehicle, route_file_path: Path):
        ...
        self.pure_pursuit_controller = PurePursuitController(vehicle=vehicle,
                                                             target_speed=150,
                                                             look_ahead_gain=0.1,
    ...
    def run_step(self, sensors_data: SensorsData, vehicle: Vehicle) -> VehicleControl:
        super(PurePursuitAgent, self).run_step(sensors_data=sensors_data, vehicle=vehicle)
