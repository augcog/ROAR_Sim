...
class LocalPlanner(AbstractPlanner):
    def __init__(self,
        ...
        self.controller = Controller(vehicle=vehicle) if controller is None else controller
        self.behavior_planner = BehaviorPlanner(vehicle=vehicle) if behavior_planner is None else behavior_planner
        self.mission_planner = MissionPlanner(vehicle=vehicle) if mission_planner is None else mission_planner
