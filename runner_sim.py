...
def main():
    ...
    try:
        ...
        # agent = JsonWaypointAgent(vehicle=my_vehicle, agent_settings=config.agent_config)
        agent = FloodfillBasedLaneFollower(vehicle=my_vehicle, agent_settings=config.agent_config)
